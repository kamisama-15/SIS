                           ...
                           <div class="card-body" id="card-container">
                              <div class="row my-0">
                                 <div class="col-12">
                                    ...
                                    <h5 class="text-center mb-2 text-bold fs-5 fs-md-4">Learner's Permanent Academic Record for Elementary School</h5>
                                 </div>
                              </div>
                              <div class="row my-0  bg-color justify-content-center align-items-center border border-dark">
                                 <h5 class="text-bold text-sm">
                                 LEARNER'S PERSONAL INFORMATION</h6>
                              </div>
                              <div class="row my-0">
                                 <div class="col-12">
                              ...
                              <div class="row mb-1 my-0">
                                 <div class="col-12 bg-color d-flex justify-content-center align-items-center border border-dark">
                                    <h5 class="text-center text-bold text-sm">ELIGIBILITY FOR ELEMENTARY SCHOOL ENROLMENT</h5>
                                 </div>
                              </div>
                              <div class="row border border-dark px-1 pb-1 my-0">
                                 <div class="col-12">
                                    <div class="form-group row align-items-center my-0">
                                       <label for="kinderProgressReport" class="col-form-label text-super-sm">Credential Presented for Grade 1:</label>
                                       <div class="col-sm-3">
                                          <div class="form-check">
                                             <input type="checkbox" class="form-check-input" id="kpr">
                                             <label class="form-check-label text-super-sm text-bold" for="kpr">Kinder Progress Report</label>
                                          </div>
                                       </div>
                                       <div class="col-sm-2">
                                          <div class="form-check">
                                             <input type="checkbox" class="form-check-input" id="ecccdChck">
                                             <label class="form-check-label text-super-sm text-bold" for="ecccdChck">ECCD checklist</label>
                                          </div>
                                       </div>
                                       <div class="col-sm-4">
                                          <div class="form-check">
                                             <input type="checkbox" class="form-check-input" id="kcoc">
                                             <label class="form-check-label text-super-sm text-bold" for="kcoc">Kindergarten Certificated of Completion</label>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-12">
                                    <div class="form-group row align-items-center my-0">
                                       <label for="school_name" class="col-form-label text-super-sm">Name of School:</label>
                                       <div class="col-sm-3">
                              ...
                              <div class="row ml-3">
                                 <div class="col-12">
                                    <div class="form-group row align-items-center my-0">
                                       ...
                                       <label for="exam_date" class="col-form-label text-super-sm">Date of Examination/Assessment (mm/dd/yyyy):</label>
                                       <div class="col-sm-1">
                                          <input type="text" class="form-control form-input-height form-control-border form-control-sm form-control-border-dark" id="exam_date" placeholder="">
                                       </div>
                                 ...
                                 <div class="col-12">
                                    <div class="form-group row align-items-center my-0">
                                       ...
                                       <label for="remark" class="col-form-label text-super-sm">Remark:</label>
                                       <div class="col-sm-2">
                              ...
                              <div class="row justify-content-sm-between mb-1" >
                                 <div class="col-5-5 border border-dark p-2">
                                    <div class="container-fluid">
                                       <div class="row">
                                          <div class="row px-2 ">
                                             <div class="col-12">
                              ...
                              <div class="card mt-2 mb-0">
                                 ...
                                 <div class="card-body border border-dark py-0">
                                    <div class="small-text">
                                       <p class="card-text text-center m-0" style="display: flex; align-items: center; font-size: 8px;">
                                       ...
                                       <div class="card-text text-center">
                                          <div style="display: flex; justify-content: space-around; align-items: center;">
                                             <div style="display: flex; flex-direction: column; align-items: center;">
                                                ...
                                                <p class="card-text m-0" style="font-size: 8px;">Date:</p>
                                             </div>
                                             <div style="display: flex; flex-direction: column; align-items: center;">
                                                <span  style="display: inline-block;">
                                                ...
                                                <p class="card-text m-0" style="font-size: 8px;">Name of Principal/School Head over Printed Name</p>
                                             </div>
                                             <p class="card-text m-0 pt-2" style="font-size: 8px;">(Affix School Seal here)</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
